...
public class Techcrunch_Case {
    ...
    //  We deleted " | Techcrunch" text part on the browser title to get the raw title to check equality
    //  We use equals() to get highly sensitive test results as the return of that approach we had to handle
    //  hidden characters in java with regex
